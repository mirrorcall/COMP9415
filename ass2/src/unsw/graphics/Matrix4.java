...
public class Matrix4 {
    ...
    /**
     * Construct a matrix from the given i, j, k, phi vectors
     *
     * @param i
     * @param j
     * @param k
     * @param phi
     */
    public Matrix4(Vector4 i, Vector4 j, Vector4 k, Vector4 phi) {
        float[] values = new float[16];
        System.arraycopy(i.getValues(), 0, values, 0, 4);
        System.arraycopy(j.getValues(), 0, values, 4, 4);
        System.arraycopy(k.getValues(), 0, values, 8, 4);
        System.arraycopy(phi.getValues(), 0, values, 12, 4);
        this.values = values;
    }
